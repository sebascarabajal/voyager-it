    ...
    return (
        <div className='min-h-screen'>
            <div className="flex flex-col items-center">
                ...
                <div className="max-w-screen-md mx-4">
                    A continuaci&oiacute; te dejamos el bot&oacute;n de descarga para que puedas acceder a la documentaci&oacute;n completa en PDF.
                </div>
