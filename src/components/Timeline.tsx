        ...
        <div className="sm:flex sm:justify-center sm:items-center sm:min-h-screen">
            ...
            <ol className="relative border-s border-gray-200 dark:border-gray-700">
                ...
                <li className="mb-10 ms-4">
                    ...
                    <a href="/projects/Ionixx" className="inline-flex items-center px-4 py-2 text-sm font-medium text-teal-500 border-[#116b4e]  border rounded-lg focus:z-10 focus:ring-4 focus:outline-none ">Look at the project<svg className="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
