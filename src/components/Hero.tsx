...
function Hero() {
    ...
    const [text] = useTypewriter({
        words: ['future.', 'IT solutions.', 'IT services.', 'IT support.', 'IT experience.', 'IT company.', 'IT team.', 'IT experts.', 'IT professionals.'],
        loop: false,
        deleteSpeed: 70,
        ...
        <div className=" flex items-center justify-center py-4 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                <div>
                    ...
                    <p className="mt-2 text-center text-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">Welcome to the best {text}</p>
