    ...
    return (
        <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                <Link href={""} className="text-lg px-4 py-2 text-teal-500 border-[#116b4e] border rounded md:w-1/5">Introduccion</Link>
                <Link href={""} className="text-lg px-4 py-2 text-teal-500 border-[#116b4e] border rounded md:w-1/5">Lista de materiales</Link>
                <Link href={""} className="text-lg px-4 py-2 text-teal-500 border-[#116b4e] border rounded md:w-1/5">Cableado estructurado</Link>
